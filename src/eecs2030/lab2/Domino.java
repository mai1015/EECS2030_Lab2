...
public class Domino implements Comparable<Domino> {
	...
	public Domino(int value1, int value2) {
		if (!(Domino.isValueOK(value1) && Domino.isValueOK(value2)))
			throw new IllegalArgumentException("Value has to be between 0 and 6");
	...
	public int compareTo(Domino other) {
		int result = getSmallerValue() - other.getSmallerValue();
		if (result == 0)
	...
	public boolean equals(Object obj) {
		if (obj instanceof Domino) {
			...
			return getSmallerValue() == other.getSmallerValue() &&
					getLargerValue() == other.getLargerValue();
		}
		return false;
	}
	...
	public String toString() {
		return String.format("[%d : %d]", getSmallerValue(), getLargerValue());
	}
